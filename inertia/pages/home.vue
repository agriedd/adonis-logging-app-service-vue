...
<template>
  ...
  <div class="p-4 flex justify-center items-center min-h-screen flex-col 
    bg-zinc-900">
    <div class="border rounded-2xl max-w-sm w-full bg-zinc-800 text-white border-zinc-700 shadow group">
      <div class="p-6 lg:p-10 lg:py-6 flex w-full flex-row-reverse items-center gap-4">
        <div class="bg-zinc-900 rounded-full w-12 aspect-[3/4] border-b-2 border-zinc-700 flex justify-center items-center text-sky-800 fill-sky-900
          group-hover:fill-sky-500 transition-all group-hover:animate-pulse">
      ...
      <FormData @submit="submit" :disabled="loading">
        <div class="p-6 lg:p-10 flex gap-3 flex-col">
          ...
          <div>
            ...
            <TextField class="rounded-md" placeholder="Password" type="password" v-model="form.password" />
          </div>
          <div class="pt-4">
